 ...
 */
public class TDistr extends AbstractRealDistribution {
    /**
     ...
     */
    public TDistr(double degreesOfFreedom)
    ...
    public TDistr()
            throws NotStrictlyPositiveException {
            this(1.0, DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
        }
     ...
     * @since 2.1
     */
    public TDistr(double degreesOfFreedom, double inverseCumAccuracy)
        throws NotStrictlyPositiveException {
     ...
     * @since 3.1
     */
    public TDistr(RandomGenerator rng,
