 ...
 */
public class NormalDistr extends AbstractRealDistribution {
    /**
     ...
     * @since 2.1
     */
    public NormalDistr(double mean, double sd, double inverseCumAccuracy)
        throws NotStrictlyPositiveException {
     ...
     * @since 3.1
     */
    public NormalDistr(RandomGenerator rng,
                              double mean,
                              double sd,
    ...
    public void setDistrParameters(double mu, double sigma)  {
    	mean = mu;
