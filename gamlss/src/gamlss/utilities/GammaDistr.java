 ...
 */
public class GammaDistr extends AbstractRealDistribution {
    /**
     ...
     * {@code scale <= 0}.
     */
    public GammaDistr(double shape, double scale) throws NotStrictlyPositiveException {
        this(shape, scale, DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
    }
    
    public GammaDistr() throws NotStrictlyPositiveException {
        this(1.0, 1.0, DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
    }
     ...
     * @since 2.1
     */
    public GammaDistr(double shape, double scale, double inverseCumAccuracy)
     ...
     * @since 3.1
     */
    public GammaDistr(RandomGenerator rng,
                             double shape,
                             double scale,
    ...
    public void setDistrParameters(double sh, double sc)  {
    	shape = sh;
    	scale = sc;
    }
}