...
public class SimpleFunctionOptimizer extends Object {
	...
	protected double absoluteTolerance = Double.MIN_VALUE;
	protected double relativeTolerance = 1.0e-10;
	protected boolean printWarnings = true;
	protected boolean useInitialGuess = true;
	protected double initialGuess = 10;
